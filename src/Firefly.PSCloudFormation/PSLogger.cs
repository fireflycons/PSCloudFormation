...
#pragma warning restore 649
        ...
        /// <summary>
        /// <see cref="JsonConverter"/> class to convert <see cref="DateTime"/> values into a more legible UTC format
        /// </summary>
        /// <seealso cref="Newtonsoft.Json.JsonConverter" />
        private class DateTimeJsonConverter : JsonConverter
        {
            ...
            public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
            {
                new JValue(((DateTime)value).ToUniversalTime().ToString("yyyy-MM-dd HH:mm:ss UTC")).WriteTo(writer);
            }
