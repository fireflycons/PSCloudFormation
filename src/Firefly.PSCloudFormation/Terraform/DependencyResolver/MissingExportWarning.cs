namespace Firefly.PSCloudFormation.Terraform.DependencyResolver
{
    ...
    /// <summary>
    /// Thrown internally when an exported value for an <c>!ImportValue</c> cannot be found.
    /// Where this occurs, the HCL attribute will be output with its current value from state, i.e. unresolved.
    /// </summary>
    [Serializable]
    internal class MissingExportWarning : DependencyResolutionWarning
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="MissingExportWarning"/> class.
        /// </summary>
        protected MissingExportWarning()
        {
        }
        ...
        protected MissingExportWarning(string message)
            : base(message)
        {
        }
        ...
        protected MissingExportWarning(string message, Exception inner)
            : base(message, inner)
        {
        }
        ...
        protected MissingExportWarning(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        public override string Message =>
            $"Resource {this.AwsResourceName}: Unable to find exported value for \"{this.Intrinsic.TagName}\" at property \"{this.Location.Path}\". HCL will contain current attribute value.";
    }
}