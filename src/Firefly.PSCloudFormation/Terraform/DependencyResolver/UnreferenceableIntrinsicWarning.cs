namespace Firefly.PSCloudFormation.Terraform.DependencyResolver
{
    ...
    [Serializable]
    internal class UnreferenceableIntrinsicWarning : DependencyResolutionWarning
    {
        /// <summary>
        ...
        protected UnreferenceableIntrinsicWarning(string message, Exception inner)
            : base(message, inner)
        {
        }
        ...
        /// Initializes a new instance of the <see cref="UnreferenceableIntrinsicWarning"/> class.
        /// </summary>
        protected UnreferenceableIntrinsicWarning()
        {
        }
        ...
        protected UnreferenceableIntrinsicWarning(string message)
            : base(message)
        {
        }
        ...
        protected UnreferenceableIntrinsicWarning(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        public override string Message =>
            $"Resource {this.AwsResourceName}: Unable to create reference for \"{this.Intrinsic.TagName}\" at property \"{this.Location.Path}\". HCL will contain current attribute value.";
    }
}