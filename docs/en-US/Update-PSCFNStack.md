...
Update-PSCFNStack [-StackName] <String> [-TemplateLocation <String[]>] [-Capabilities <String[]>]
 ...
 [-RollbackConfiguration <RollbackConfiguration>] [-Tag <Tag[]>] [-ParameterFile <String>] [-PassThru]
 [-ResourcesToImport <String>] [-Wait] [-Force] [-BackupTemplate] [-ProfileName <String>]
...
### PreviousTemplate
```
Update-PSCFNStack [-StackName] <String> [-Capabilities <String[]>] [-NotificationARNs <String[]>]
 [-ResourceType <String[]>] [-RoleARN <String>] [-RollbackConfiguration <RollbackConfiguration>] [-Tag <Tag[]>]
 [-UsePreviousTemplate] [-ParameterFile <String>] [-PassThru] [-ResourcesToImport <String>] [-Wait] [-Force]
 [-BackupTemplate] [-ProfileName <String>] [-EndpointUrl <String>] [-AccessKey <String>] [-SecretKey <String>]
...
Parameter Sets: PreviousTemplate
Aliases:
